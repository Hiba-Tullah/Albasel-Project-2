...
<div style="padding-top: 50px">
        ...
        <div class="main-section-area">
                  ...
                  <div class="row" style="padding-left: 60px">
                   ...
                   <div class="column">
                           ...
                           <div class="column">
                            ...
                            <div class="widget-title">
                                 <button class="btn"> <b>Change  </br>Room  </br>Diagram</b></button>
                            </div>
                 ...
                 <div class="column">
                            ...
                            <div class="widget-title">
                              ...
                              <button type="button" class="btn btn-primary btn-lg" data-toggle="modal" data-target="#Modal">
                               <b>Change </br> Nursing  </br>Duties </b>
                          </button>
                            </div> 
           ...
           <h5 class="modal-title" id="exampleModalLabel">Change Nursing Duties</h5>
                                </div>
                                  ...
                                  <div class="form-group">
                                        ...
                                        <label for="recipient-name" class="col-form-label">Shift Time:</label>
                                         <label for="recipient-name" class="col-form-label">From-> dd/mm/yy : HH:MM:SS am/pm</label>
                                          <input type="text" class="form-control" id="recipient-name" autofocus style="background-color: #7b7f80" >
                                           <label for="recipient-name" class="col-form-label">To-> dd/mm/yy : HH:MM:SS am/pm</label>
                                           <input type="text" class="form-control" id="recipient-name" autofocus style="background-color: #7b7f80" >
